...
def solicitar_exames(request):
    ...
    if request.method == "GET":
        ...
        return render(request, 'solicitar_exames.htm', {'tipos_exames': tipos_exames})
        ...
        return render(request, 'solicitar_exames.htm', {'tipos_exames': tipos_exames, 'solicitacao_exames': solicitacao_exames, 'preco_total': preco_total})
...
def gerenciar_pedidos(request):
    ...
    return render(request, 'gerenciar_pedidos.htm', {'pedidos_exames': pedidos_exames})   
...
def gerenciar_exames(request):
    ...
    return render(request, 'gerenciar_exames.htm', {'exames': exames})
...
def solicitar_senha_exame(request, exame_id):
    exame = SolicitacaoExame.objects.get(id=exame_id)
    if request.method == "GET":
        return render(request, 'solicitar_senha_exame.htm', {'exame': exame})
    elif request.method == "POST":
...
def gerar_acesso_medico(request):
    if request.method == "GET":
        ...
        return render(request, 'gerar_acesso_medico.htm', {'acessos_medicos': acessos_medicos})
    elif request.method == "POST":
...
def acesso_medico(request, token):
    ...
    print(pedidos)
    return render(request, 'acesso_medico.htm', {'pedidos':pedidos})